...
try:
    ...
    # Load DistilBERT for extractive QA
...
with gr.Blocks(css=custom_css, title="Retrieval-Based Chatbot", theme=gr.themes.Soft()) as demo:
    ...
    gr.HTML("""
        <div class="description">
            <p>Please ask questions about the MSc Artificial Intelligence Online program at the University of Hull or Keele University. 
            This chatbot uses MiniLM embeddings for retrieval and DistilBERT for extractive answers. 
            Please include the word *'Hull'* or *'Keele'* in your question so I know which programme you mean.</p>
        </div>
    """)
