...
with gr.Blocks(css=custom_css, title="Centralized RAG Chatbot", theme=gr.themes.Soft()) as demo:
    ...
    gr.HTML("""
        <div class="main-header">
            ...
            <p style="font-size: 1rem; opacity: 0.8;">Uses centralized approach to retrieve MSc AI online program information at University of Hull</p>
        </div>
    """)
    ...
    gr.HTML("""
        <div class="description">
            <p><strong>How it works:</strong> This RAG (Retrieval-Augmented Generation) system combines document retrieval
        ...
        with gr.Column(scale=2):
            ...
            with gr.Row():
                question_input = gr.Textbox(
                    ...
                    placeholder="e.g., How long does the MSc Artificial Intelligence course at University of Hull take to complete?",
                    lines=2,
                    scale=4
                )
                ask_btn = gr.Button(
    ...
    gr.HTML("""
        <div class="info-box">
            ...
            <ol>
                <li>How long does the MSc Artificial Intelligence (Online) program at University of Hull take to complete?</li>
                <li>What is the total cost of the MSc Artificial Intelligence (Online) program at University of Hull?</li>
