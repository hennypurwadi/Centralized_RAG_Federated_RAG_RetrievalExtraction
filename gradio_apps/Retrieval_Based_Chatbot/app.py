...
with gr.Blocks(css=custom_css, title="Retrieval-Based Chatbot", theme=gr.themes.Soft()) as demo:
    ...
    example_btn1.click(
        fn=lambda: "What will be on my degree certificate after completing an online Masters course at the University of Hull?",
        outputs=[question_input]
    )
    
    example_btn2.click(
        fn=lambda: "Is there a graduation ceremony for online students at the University of Hull?",
        outputs=[question_input]
    )
    
    example_btn3.click(
        fn=lambda: "What is the phone number to reach the course advisers at the University of Hull?",
        outputs=[question_input]
    )
    
    example_btn4.click(
        fn=lambda: "What is the email address for enquiries about online courses at the University of Hull?",
        outputs=[question_input]
    )
    
    example_btn5.click(
        fn=lambda: "What are the payment options available for paying tuition fees at the University of Hull Online?",
        outputs=[question_input]
    )
    
    example_btn6.click(
        fn=lambda: "Is there any discount available for referring a friend to the University of Hull Online?",
        outputs=[question_input]
    )
